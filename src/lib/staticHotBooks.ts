...
export const STATIC_HOT_BOOKS: StaticHotBook[] = [
  {
    ...
    keyFacts: [
      ...
      "Second appearance of Fantastic Four"
    ],
    whyHot: "Doctor Doom's upcoming MCU debut and consistent collector demand for this classic villain key",
    priceRange: { low: 1200, mid: 2500, high: 5000 },
    coverImageUrl: "https://comicvine.gamespot.com/a/uploads/scale_medium/10/108995/3593371-ff%20005_cf_bk_hk.jpg"
  },
  {
    rank: 2,
    title: "X-Men",
  ...
  },
  {
    ...
    year: "2011",
    keyFacts: [
      "First appearance of Miles Morales as Spider-Man"
    ],
  ...
  },
  {
    ...
    year: "2014",
    keyFacts: [
      "First appearance of Kamala Khan as Ms. Marvel"
    ],
    whyHot: "Disney+ series success and upcoming movie 'The Marvels' featuring the character",
    priceRange: { low: 80, mid: 150, high: 300 },
    coverImageUrl: "https://comicvine.gamespot.com/a/uploads/scale_medium/0/4/15354-2910-17111-1-ms-marvel.jpg"
  },
  {
    rank: 5,
    title: "New Mutants",
  ...
  },
  {
    ...
    coverImageUrl: "https://comicvine.gamespot.com/a/uploads/scale_medium/11/117763/2844051-ironman055.jpg"
  },
  {
    rank: 7,
    ...
    year: "1984",
    keyFacts: [
      "First appearance of TMNT",
      "Origin story of the Teenage Mutant Ninja Turtles"
    ],
    whyHot: "New TMNT movie announcements and 40th anniversary approaching",
    priceRange: { low: 1500, mid: 3000, high: 6000 },
    coverImageUrl: "https://comicvine.gamespot.com/a/uploads/scale_medium/0/4/71033-11889-104031-1-teenage-mutant-ninja.jpg"
  },
  {
    rank: 8,
    title: "Wolverine",
    ...
    year: "1982",
    keyFacts: [
      "First solo Wolverine limited series",
      "Key Wolverine collectible"
    ],
    whyHot: "Hugh Jackman returning as Wolverine in Deadpool 3, renewed interest in character",
    priceRange: { low: 60, mid: 120, high: 250 },
    coverImageUrl: "https://comicvine.gamespot.com/a/uploads/scale_medium/11161/111615891/9300027-3983472080-30841.jpg"
  },
  {
    rank: 9,
    title: "Saga",
    ...
    year: "2012",
    keyFacts: [
      "First issue of acclaimed series by Brian K. Vaughan and Fiona Staples"
    ],
    whyHot: "Series return from hiatus and continued speculation about TV/movie adaptation",
    priceRange: { low: 100, mid: 200, high: 400 },
    coverImageUrl: "https://comicvine.gamespot.com/a/uploads/scale_medium/0/4/62641-3239-95637-1-saga-of-crystar-cry.jpg"
  },
  {
    rank: 10,
    ...
    keyFacts: [
      ...
      "First Silver Age Captain Marvel"
    ],
    whyHot: "The Marvels movie release and cosmic MCU expansion driving interest",
    priceRange: { low: 200, mid: 400, high: 800 },
    coverImageUrl: "https://comicvine.gamespot.com/a/uploads/scale_medium/0/4/7691-2326-8486-1-captain-marvel.jpg"
  }
];
