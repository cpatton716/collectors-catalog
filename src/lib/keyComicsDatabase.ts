...
const KEY_COMICS: KeyComic[] = [
  ...
  // MARVEL - SPIDER-MAN
  // ============================================
  { title: "Amazing Fantasy", issue: "15", keyInfo: ["First appearance of Spider-Man", "First appearance of Uncle Ben", "First appearance of Aunt May"] },
  { title: "Amazing Spider-Man", issue: "1", keyInfo: ["First issue of Amazing Spider-Man series", "First appearance of J. Jonah Jameson", "First appearance of Chameleon"] },
  ...
  { title: "Amazing Spider-Man", issue: "4", keyInfo: ["First appearance of Sandman", "First appearance of Betty Brant"] },
  ...
  { title: "Amazing Spider-Man", issue: "25", keyInfo: ["First cameo appearance of Mary Jane Watson"] },
  { title: "Amazing Spider-Man", issue: "28", keyInfo: ["First Molten Man"] },
  { title: "Amazing Spider-Man", issue: "31", keyInfo: ["First appearance of Gwen Stacy", "First appearance of Harry Osborn"] },
  { title: "Amazing Spider-Man", issue: "42", keyInfo: ["First full appearance of Mary Jane Watson"] },
  { title: "Amazing Spider-Man", issue: "50", keyInfo: ["First appearance of Kingpin", "Classic 'Spider-Man No More' cover"] },
  { title: "Amazing Spider-Man", issue: "101", keyInfo: ["First appearance of Morbius the Living Vampire"] },
  { title: "Amazing Spider-Man", issue: "121", keyInfo: ["Death of Gwen Stacy"] },
  { title: "Amazing Spider-Man", issue: "122", keyInfo: ["Death of the Green Goblin (Norman Osborn)"] },
  { title: "Amazing Spider-Man", issue: "129", keyInfo: ["First appearance of the Punisher", "First appearance of the Jackal"] },
  ...
  { title: "Amazing Spider-Man", issue: "252", keyInfo: ["First appearance of Spider-Man's black costume in main continuity"] },
  { title: "Amazing Spider-Man", issue: "298", keyInfo: ["First Todd McFarlane art on Amazing Spider-Man", "First cameo of Eddie Brock"] },
  { title: "Amazing Spider-Man", issue: "299", keyInfo: ["First cameo appearance of Venom"] },
  { title: "Amazing Spider-Man", issue: "300", keyInfo: ["First full appearance of Venom", "Origin of Venom"] },
  ...
  { title: "Amazing Spider-Man", issue: "654", keyInfo: ["First appearance of Agent Venom (Flash Thompson)"] },
  { title: "Amazing Spider-Man", issue: "667", keyInfo: ["First Spider-Island"] },
  { title: "Amazing Spider-Man", issue: "700", keyInfo: ["Death of Peter Parker", "Doctor Octopus becomes Spider-Man"] },

  // ============================================
  // MARVEL - SECRET WARS
  // ============================================
  { title: "Secret Wars", issue: "1", keyInfo: ["First issue of Marvel Super Heroes Secret Wars", "Major Marvel crossover event begins"] },
  { title: "Secret Wars", issue: "8", keyInfo: ["First appearance of Spider-Man's black symbiote costume", "Origin of the symbiote that becomes Venom"] },
  { title: "Marvel Super Heroes Secret Wars", issue: "1", keyInfo: ["First issue of Marvel Super Heroes Secret Wars", "Major Marvel crossover event begins"] },
  { title: "Marvel Super Heroes Secret Wars", issue: "8", keyInfo: ["First appearance of Spider-Man's black symbiote costume", "Origin of the symbiote that becomes Venom"] },
  { title: "Marvel Super-Heroes Secret Wars", issue: "1", keyInfo: ["First issue of Marvel Super Heroes Secret Wars", "Major Marvel crossover event begins"] },
  { title: "Marvel Super-Heroes Secret Wars", issue: "8", keyInfo: ["First appearance of Spider-Man's black symbiote costume", "Origin of the symbiote that becomes Venom"] },
  ...
  // MARVEL - X-MEN
  // ============================================
  { title: "X-Men", issue: "1", keyInfo: ["First appearance of the X-Men", "First appearance of Professor X", "First appearance of Magneto", "First appearance of Cyclops, Marvel Girl, Beast, Angel, Iceman"] },
  { title: "X-Men", issue: "4", keyInfo: ["First appearance of Scarlet Witch", "First appearance of Quicksilver", "First appearance of Brotherhood of Evil Mutants"] },
  ...
  { title: "X-Men", issue: "94", keyInfo: ["New X-Men team begins (Wolverine, Storm, Colossus, Nightcrawler join)"] },
  ...
  { title: "X-Men", issue: "129", keyInfo: ["First appearance of Kitty Pryde", "First appearance of Emma Frost"] },
  ...
  { title: "Uncanny X-Men", issue: "94", keyInfo: ["New X-Men team begins (Wolverine, Storm, Colossus, Nightcrawler join)"] },
  { title: "Uncanny X-Men", issue: "101", keyInfo: ["First appearance of Phoenix"] },
  { title: "Uncanny X-Men", issue: "129", keyInfo: ["First appearance of Kitty Pryde", "First appearance of Emma Frost"] },
  ...
  { title: "Giant-Size X-Men", issue: "1", keyInfo: ["First appearance of the new X-Men team", "First appearance of Storm", "First appearance of Colossus", "First appearance of Nightcrawler", "Second appearance of Wolverine"] },

  // ============================================
  // MARVEL - WOLVERINE / HULK
  // ============================================
  { title: "Incredible Hulk", issue: "1", keyInfo: ["First appearance of the Hulk", "First appearance of Bruce Banner"] },
  ...
  { title: "Incredible Hulk", issue: "340", keyInfo: ["Classic Todd McFarlane Wolverine vs Hulk cover"] },
  { title: "Incredible Hulk", issue: "377", keyInfo: ["Professor Hulk"] },
  { title: "Incredible Hulk", issue: "449", keyInfo: ["First Thunderbolts"] },
  { title: "Wolverine", issue: "1", keyInfo: ["First Wolverine limited series", "Frank Miller art"] },
  ...
  { title: "New Mutants", issue: "98", keyInfo: ["First appearance of Deadpool", "First appearance of Domino"] },
  ...
  // MARVEL - AVENGERS
  // ============================================
  { title: "Avengers", issue: "1", keyInfo: ["First appearance of the Avengers team", "First Avengers lineup: Thor, Iron Man, Hulk, Ant-Man, Wasp"] },
  { title: "Avengers", issue: "4", keyInfo: ["First Silver Age appearance of Captain America", "Captain America joins the Avengers"] },
  ...
  { title: "Iron Man", issue: "55", keyInfo: ["First appearance of Thanos", "First appearance of Drax the Destroyer"] },
  ...
  { title: "Captain America", issue: "1", keyInfo: ["First appearance of Captain America (Golden Age)", "First appearance of Bucky Barnes", "First appearance of Red Skull"] },
  ...
  // ============================================
  { title: "Fantastic Four", issue: "1", keyInfo: ["First appearance of the Fantastic Four", "First appearance of Mole Man"] },
  ...
  { title: "Fantastic Four", issue: "48", keyInfo: ["First appearance of Silver Surfer", "First appearance of Galactus"] },
  ...
  // ============================================
  { title: "Marvel Super-Heroes", issue: "18", keyInfo: ["First appearance of the original Guardians of the Galaxy"] },
  ...
  { title: "Infinity Gauntlet", issue: "1", keyInfo: ["Infinity Gauntlet storyline begins", "Thanos wields the Infinity Gauntlet"] },
  ...
  // ============================================
  { title: "Daredevil", issue: "1", keyInfo: ["First appearance of Daredevil", "Origin of Daredevil"] },
  ...
  { title: "Daredevil", issue: "168", keyInfo: ["First appearance of Elektra", "Frank Miller's Daredevil run begins"] },
  ...
  // ============================================
  { title: "Marvel Spotlight", issue: "5", keyInfo: ["First appearance of Ghost Rider (Johnny Blaze)"] },
  ...
  // ============================================
  { title: "Ultimate Fallout", issue: "4", keyInfo: ["First appearance of Miles Morales as Spider-Man"] },
  { title: "Edge of Spider-Verse", issue: "2", keyInfo: ["First appearance of Spider-Gwen (Gwen Stacy as Spider-Woman)"] },
  ...
  { title: "Detective Comics", issue: "359", keyInfo: ["First appearance of Batgirl (Barbara Gordon)"] },
  ...
  { title: "Batman", issue: "1", keyInfo: ["First appearance of Joker", "First appearance of Catwoman"] },
  ...
  { title: "Batman Adventures", issue: "12", keyInfo: ["First comic book appearance of Harley Quinn"] },
  { title: "Batman: The Killing Joke", issue: "1", keyInfo: ["The Killing Joke - Alan Moore/Brian Bolland", "Barbara Gordon paralyzed"] },
  { title: "Batman: Dark Knight Returns", issue: "1", keyInfo: ["The Dark Knight Returns begins - Frank Miller"] },
  ...
  // DC - SUPERMAN
  // ============================================
  { title: "Action Comics", issue: "1", keyInfo: ["First appearance of Superman", "Most valuable comic book in existence"] },
  ...
  { title: "Superman's Pal Jimmy Olsen", issue: "134", keyInfo: ["First appearance of Darkseid (cameo)"] },
  ...
  // ============================================
  { title: "Showcase", issue: "4", keyInfo: ["First appearance of Barry Allen Flash", "Beginning of the Silver Age of Comics"] },
  ...
  { title: "Flash", issue: "123", keyInfo: ["Flash of Two Worlds - first Silver Age/Golden Age crossover", "Introduction of the multiverse concept"] },
  ...
  { title: "Green Lantern", issue: "76", keyInfo: ["Green Lantern/Green Arrow begins - Dennis O'Neil/Neal Adams"] },
  ...
  // ============================================
  { title: "Brave and the Bold", issue: "28", keyInfo: ["First appearance of the Justice League of America"] },
  ...
  { title: "New Teen Titans", issue: "1", keyInfo: ["First appearance of the New Teen Titans team"] },
  { title: "New Teen Titans", issue: "2", keyInfo: ["First appearance of Deathstroke"] },
  { title: "DC Comics Presents", issue: "26", keyInfo: ["First appearance of Cyborg", "First appearance of Raven", "First appearance of Starfire"] },
  { title: "Tales of the Teen Titans", issue: "44", keyInfo: ["First appearance of Nightwing costume"] },
  ...
  { title: "Flashpoint", issue: "1", keyInfo: ["Flashpoint event begins", "Leads to New 52 reboot"] },
  { title: "Dark Nights: Metal", issue: "2", keyInfo: ["First appearance of the Batman Who Laughs"] },
  ...
  // IMAGE - SPAWN
  // ============================================
  { title: "Spawn", issue: "1", keyInfo: ["First appearance of Spawn", "Todd McFarlane creator-owned"] },
  ...
  // ============================================
  { title: "Walking Dead", issue: "1", keyInfo: ["First appearance of Rick Grimes", "Walking Dead series begins"] },
  ...
  // INDEPENDENT - CLASSIC
  // ============================================
  { title: "Teenage Mutant Ninja Turtles", issue: "1", keyInfo: ["First appearance of the Teenage Mutant Ninja Turtles"] },
