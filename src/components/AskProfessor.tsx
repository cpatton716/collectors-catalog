...
const faqs: FAQItem[] = [
  {
    ...
    answer:
      "Click 'Scan a Book' on the home page. You can either upload a photo of the cover for technopathic recognition, scan a barcode, or enter details manually. After reviewing the details, click 'Add to Collection'.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Price estimates are generated using technopathy based on recent market trends. They provide a general guideline but actual prices can vary based on condition, demand, and where you sell. For the most accurate values, check recent eBay sold listings.",
  },
  {
