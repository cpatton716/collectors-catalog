    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <div className="bg-white rounded-xl shadow-sm p-8 prose prose-gray max-w-none">
          ...
          <h2>Introduction</h2>
          <p>
            Collectors Chest (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;) respects your
            ...
            and services at collectors-chest.com.
          </p>
          ...
          <ul>
            <li>
              <strong>Account Information:</strong> Email address, display name when you create an
              account via Clerk
            </li>
            <li>
              <strong>Collection Data:</strong> Comic book information you add to your collection
            </li>
            <li>
              <strong>Transaction Data:</strong> Payment and shipping information for marketplace
              purchases
            </li>
            <li>
              <strong>Images:</strong> Photos you upload for cover recognition or listings
            </li>
          </ul>
          ...
          <ul>
            <li>
              <strong>Usage Data:</strong> Pages visited, features used, scan counts
            </li>
            <li>
              <strong>Device Information:</strong> Browser type, operating system, device type
            </li>
            <li>
              <strong>Analytics:</strong> Aggregated usage patterns via PostHog
            </li>
          </ul>
          ...
          <ul>
            ...
            <li>
              <strong>Anthropic:</strong> AI-powered cover recognition
            </li>
            <li>
          ...
          <p>
            ...
            information under the California Consumer Privacy Act (CCPA) and California Privacy
            Rights Act (CPRA):
          </p>
          <ul>
            <li>
            ...
            <li>
              <strong>Right to Opt-Out:</strong> You can opt out of the sale or sharing of your
              personal information. Note: We do not sell your personal information.
            </li>
            <li>
          ...
          <p>
            ...
            to provide services. You can delete your account at any time through your profile
            settings.
          </p>
