...
export default function HotBooksClient({ initialBooks }: HotBooksClientProps) {
  const router = useRouter();
  const [books] = useState<HotBook[]>(initialBooks);
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        {books.length === 0 ? (
          <div className="text-center py-20">
            <p className="text-gray-600">No hot books available at the moment.</p>
          </div>
        ) : (
                ...
                {selectedBook ? (
                  <>
                    ...
                    {selectedBook.coverImageUrl && (
                      <div className="w-full aspect-[2/3] max-w-[240px] sm:max-w-[180px] mx-auto mb-4 bg-gray-100 rounded-lg overflow-hidden shadow-md relative">
                        <Image
